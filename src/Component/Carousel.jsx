...
import img2 from '../assets/image-folder/meeting-notes.png';
  ...
  return (
    <>
      <div id="default-carousel" className="relative w-full" data-carousel="slide">
        ...
        <button type="button" onClick={handlePrevSlide} className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
