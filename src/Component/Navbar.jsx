...
const Navbar = ({ isStrue, setisStrue }) => {
    ...
    return (
        <>
            ...
            <nav className="z-50 sticky top-0 flex items-center bg-white justify-between w-full py-2 bg-inherit shadow-lg flex-nowrap text-black-500 hover:text-neutral-700 focus:text-neutral-700 dark:bg-white-600 lg:flex-wrap lg:justify-start lg:py-4" data-te-navbar-ref>
